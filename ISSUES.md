...
- Named-song requests now use one native Android music search/play handoff and stop rather than falling into fragile Spotify screen automation. Generic media controls remain limited to explicit active-session commands. Locked or unobservable third-party messaging apps now stop with a manual/SMS fallback instead of repeated element actions.
